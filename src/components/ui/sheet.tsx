...
function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 z-50 bg-[var(--overlay)] transition-opacity duration-150 data-ending-style:opacity-0 data-starting-style:opacity-0",
        className
      )}
      {...props}
    />
...
function SheetContent({
  ...
  const isPlunkSide = side === "left" || side === "right"
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          ...
          isPlunkSide && "np-plunk np-plunk-lg",
          className
        )}
        {...props}
      >
